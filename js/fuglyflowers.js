...
Public Domain 2013 by Matthias D̦rfelt
...
var StraightGrowPreset = function()
{
    ...
    this.generate = function(_origin, _direction, _length, _segmentCount)
    {
        var ret = [];
...
var TaperedLineRenderPreset = function()
{
...
var BlossomCenterCirclePreset = function()
{
    this.draw = function(_position, _size)
    {
...
var BlossomCenterStarPreset = function()
{
    this.draw = function(_position, _size)
    {
...
var BlossomCenterEllipsePreset = function()
{
    this.draw = function(_position, _size)
    {
...
var BlossomLeavesAsLines = function()
{
    this.draw = function(_bloomCenterPath, _leafLength)
    {
...
var BlossomLeavesAsCircles = function()
{
    this.draw = function(_bloomCenterPath, _leafLength)
    {
        var leafCount = 5 + Math.random() * 10;
